...
const ColorPicker = () => {
  ...
  return (
    <>
      ...
      <div className="  flex space-x-8 p-4 justify-center items-center">
        {/* Black Color Option */}
        <div
        ...
        <div
          ...
          className={`relative flex flex-col items-center p-8 cursor-pointer rounded-md transition-all ${
            selectedColor === "gray" ? "ring-4 ring-white" : ""
          }`}
        ...
        <div
          ...
          className={`relative flex flex-col items-center p-8 cursor-pointer rounded-md transition-all ${
            selectedColor === "white" ? "ring-4 ring-black" : ""
          }`}
        ...
        <div
          ...
          className={`relative flex flex-col items-center p-8 cursor-pointer rounded-md transition-all ${
            selectedColor === "clear" ? "ring-4 ring-white" : ""
          }`}
      ...
      <div className=" flex justify-center">
        <Button className=" bg-main text-center text-2xl w-full max-w-[30%] mx-auto my-20 p-2 ">
          Update Dog Tag
        </Button>
      </div>
    </>
