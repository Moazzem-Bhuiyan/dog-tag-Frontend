...
const FontTypeOne = () => {
     return (
          <div className=" w-full lg:max-w-[60%] m-auto">
               ...
               <div className=" md:grid gap-10 md:grid-cols-3 p-5">
                    ...
                    <div className="col-span-2 space-y-5">
                         ...
                         <h1>
                              2mm x 3mm characters are raised above surface.
                              This modern military font is the most popular,
                              select this if you are unsure. Has the most
